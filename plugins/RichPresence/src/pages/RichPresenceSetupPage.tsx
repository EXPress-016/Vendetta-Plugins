        ...
        <ScrollView>
          ...
          <FormSection title='Images'>
            ...
            <Text style={styles.subText}>
              Image assets key can be either a Discord asset name or a URL to an
              image.
            </Text>
          </FormSection>
          <FormSection title='Timestamps'>
            ...
            <Text style={styles.subText}>
              {/* @ts-ignore */}
              Timestamps are in Epoch seconds. You may use{' '}
              <Text
                style={styles.textLink}
                onPress={() => url.openURL('https://www.epochconverter.com/')}
              >
                this
              </Text>{' '}
              to convert your time to Unix Epoch time.
            </Text>
            {/* @ts-ignore */}
